const data = {
    ...
    article9 : {
     ...
     article10 : {
        text1 : 'ხშირად საჭირო ხდება ერთმანეთის მსგავსი  კომპონენტების გამოტანა მონაცემთა მასივიდან. მონაცემთა მასივებზე მანიპულირებისთვის შეგიძლიათ გამოიყენოთ JavaScript-ის მასივის მეთოდები. ამ თავში ჩვენ შევეხებით filter() და map() მეთოდებს - React-ში მონაცემთა გასაფილტრად და  მონაცემთა მასივის კომპონენტების მასივად გარდასაქმნელად.',
        text2 : '•	როგორ გამოვიტანოთ კომპონენტები მასივიდან JavaScript-ის map() მეთოდის გამოყენებით',
        text3 : '•	როგორ გამოვიტანოთ მხოლოდ კონკრეტული კომპონენტები JavaScript-ის filter() მეთოდის გამოყენებით',
        text4 : '•	როდის და რატომ გამოვიყენოთ React-ის key-ები',
        text5 : 'სიის ელემენტებს  შორის ერთადერთი განსხვავება  არის მათი შინაარსი და მონაცემები. აპლიკაციის ინტერფეისის შექმნისას: თქვენ ხშირად დაგჭირდებათ ერთი და იმავე კომპონენტის რამდენიმე ადგილას გამოყენება სხვადასხვა მონაცემების გამოყენებით: კომენტარების სიებიდან დაწყებული პროფილის სურათების გალერეით დამთავრებული. ასეთ სიტუაციებში, თქვენ შეგიძლიათ შეინახოთ  მონაცემები JavaScript ობიექტებში და მასივებში და გამოიყენოთ მათზე ისეთი  მეთოდები, როგორიცაა  map() და filter() სიის კომპონენტის მისაღებად.',
        text6 : 'ქვემოთ მოცემულია მოკლე მაგალითი იმისა, თუ როგორ უნდა შექმნათ ელემენტების სია მასივიდან:',
        text7 : '2.	გამოიყენეთ map მეთოდი people მასივზე და შედეგად მიღებული JSX კვანძები შეინახეთ ახალ listItems მასივში :',
        text8 : '3.	დააბრუნეთ listItems მასივი თქვენს კომპონენტში, რომელიც მოთავსებული იქნება <ul> ტეგში:',
        text9 : 'ყურადღება მიაქციეთ, რომ  კონსოლში გამოდის შეცდომა:',
        text10 : 'ამ შეცდომის გამოსწორების გზას ცოტა მოგვიანებით გავივლით. მანამდე დავამატოთ გარკვეული სტრუქტურა თქვენს მონაცემებს.',
        text11 : 'მასივის ელემენტების ფილტრაცია',
        text12 : 'მონაცემები შეიძლება კიდევ უფრო სტრუქტურირებული იყოს.',
        text13 : "დავუშვათ, გსურს მხოლოდ იმ ადამიანების მონაცემების გამოტანა  ვისი პროფესიაცაა 'chemist'. ამისათვის შეგიძლიათ გამოიყენოთ JavaScript-ის filter() მეთოდი. ეს მეთოდი იღებს ელემენტთა მასივს, გადასცემს მათ „ტესტს“ (ფუნქცია, რომელიც აბრუნებს true ან false) და აბრუნებს მხოლოდ იმ ერთეულების ახალ მასივს, რომლებმაც გაიარეს ტესტი (დააბრუნა true).",
        text14 : "თქვენ მხოლოდ ის მონაცემები გინდათ სადაც profession არის 'chemist'. ასეთ შემთხვევაში 'ტესტ' ფუნქცია ასე გამოიყურება: (person) => person.profession === 'chemist'. გავაერთიანოთ:",
        text15 : "1. people მასივზე filter() მეთოდის გამოყენებით და მასზე person.profession === 'chemist' ტესტ ფუნქციის გადაცემით , შექმენით ახალი chemists  მასივი , სადაც  მხოლოდ 'ქიმიკოსები' იქნებიან:",
        text16 : '2. შემდეგ გამოიყენეთ map მეთოდი chemists მასივზე:',
        text17 : '3. და ბოლოს, დააბრუნეთ listItems მასივი თქვენს კომპონენტში:',
        text18 : 'როგორც იცით arrow  ფუნქციები პირდაპირ აბრუნებს =>  ნიშნის  შემდგომ გამოსახულებას, ასე რომ ამ შემთხვევაში თქვენ არ გჭირდებათ return ოპერატორი:',
        text19 : 'მაგრამ თუ ფუნქციის ტანი მოთავსებულია { } ფიგურულ ფრჩხილებში, მაშინ თქვენ აუცილებლად უნდა გამოიყენოთ   return ოპერატორი!',
        text20 : 'arrow ფუნქციებში, რომელთა ფუნქციის ტანი მოთავსებულია => { } ფიგურულ ფრჩხილებში, შესაძლებელია დაწეროთ კოდი ერთზე მეტ სტრიქონზე, მაგრამ ამასთან ერთად უნდა გამოიყენოთ return ოპერატორი, წინააღმდეგ შემთხვევაში ფუნქცია არ დააბრუნებს არაფერს!',
        text21 : 'სიის ელემენტების მოწესრიგება key-ების მეშვეობით',
        text22 : 'როგორც ზემოთ ავღნიშნეთ, კონსოლში გამოდის შეცდომა:',
        text23 : 'მასივის ყველა ელემენტს უნდა მიენიჭოს  key - სტრინგი ან რიცხვი, რომლითაც ამ ელემენტის მასივის სხვა ელემენტებისგან იდენტიფიცირება მოხდება:',
        text24 : 'JSX ელემენტებს უშუალოდ map() მეთოდის შიგნით გამოძახებისას ყოველთვის სჭირდებათ key-ები!',
        text25 : 'Key-ები ეუბნებიან React-ს, რომელი მასივის ელემენტს შეესაბამება თითოეული კომპონენტი, რათა მოგვიანებით შეძლოს მათი შედარება. ეს ძალიან მნიშვნელოვანი ხდება მაშინ, როცა მასივის ელემენტები იცვლიან ადგილებს (მაგ. სორტირების გამო), ემატება ახალი ელემენტები ან იშლება. კარგად შერჩეული key ეხმარება React-ს დაადგინოს რა მოხდა ზუსტად და გააკეთოს სწორი განახლებები DOM ხეში.',
        text26 : 'Key-ების ფუნქციაში გენერირების ნაცვლად, თქვენ უნდა შეიტანოთ ისინი თქვენს მონაცემებში:',
        text27 : 'სიის თითოეული ელემენტისთვის რამდენიმე DOM კვანძის გამოტანა',
        text28 : 'როგორ მოვიქცეთ, როდესაც სიის თითოეულ ელემენტს სჭირდება არა ერთი, არამედ რამდენიმე DOM კვანძის რენდერი?',
        text29 : 'ფრაგმენტის მოკლე <>...</> სინტაქსი არ მოგცემთ იმის საშუალებას რომ ელემენტს მიანიჭოთ key. ასე რომ კვანძები უნდა დააჯგუფოთ <div> ტეგში  ან გამოიყენოთ ფრაგმენტის ოდნავ გრძელი და გამოკვეთილი <Fragment> სინტაქსი:',
        text30 : 'ფრაგმენტები არ ჩანს  DOM-ში, ასე რომ, ეს სინტაქსი წარმოქმნის ჩვეულებრივ  სიას <h1>, <p>, <h1>, <p> და ა.შ.',
        text31 : 'საიდან ავიღოთ key',
        text32 : 'მონაცემთა სხვადასხვა წყარო იძლევა key-ების სხვადასხვა წყაროს:',
        text33 : 'მონაცემთა ბაზიდან: თუ თქვენი მონაცემებს იღებთ მონაცემთა ბაზიდან, შეგიძლიათ გამოიყენოთ მონაცემთა ბაზის გასაღებები/ID-ები, რომლებიც თავისი ბუნებით უნიკალურია.',
        text34 : 'ლოკალურად გენერირებული მონაცემები: თუ თქვენი მონაცემები გენერირდება და ინახება ლოკალურად (მაგ. შენიშვნები ჩანაწერების  აპლიკაციაში), ელემენტების შექმნისას გამოიყენეთ მრიცხველი ფუნქცია crypto.randomUUID( ) ან ისეთი პაკეტი, როგორიცაა uuid.',
        text35 : 'Key-ების გამოყენების წესები',
        text36 : 'Key-ები უნდა იყოს უნიკალური შვილობილ ელემენტებს შორის. თუმცა JSX კვანძებისთვის სხვადასხვა მასივებზე  ერთი და იგივე key-ების გამოყენება დასაშვებია.',
        text37 : 'Key-ები არ უნდა შეიცვალოს! ეს ewinaaRmdegeba მათი არსებობის იდეას. არ დააგენერიროთ ისინი რენდერის დროს.',
        text38 : 'რატომ სჭირდება React-ს key-ები?',
        text39 : 'წარმოიდგინეთ, რომ თქვენს დესკტოპზე ფაილებს სახელები არ ჰქონდეთ. ამის ნაცვლად, თქვენ მათ იყენებთ მათი თანმიმდევრობით - პირველი ფაილი, მეორე ფაილი და ა.შ. ამას შესაძლოა შეეჩვიო, მაგრამ როგორც კი წაშლი ერთ ფაილს, თანმიმდევრობა დამაბნეველი გახდება. მეორე ფაილი გახდება პირველი ფაილი, მესამე ფაილი იქნება მეორე ფაილი და ა.შ.',
        text40 : 'ფაილების სახელები საქაღალდეში და JSX key-ები მასივში - მსგავს მიზანს ემსახურება. ისინი საშუალებას გვაძლევს ზუსტად  ამოვიცნოთ ელემენტები  სხვა მსგავს ელემენტებს შორის. კარგად შერჩეული key იძლევა უფრო მეტ ინფორმაციას, ვიდრე ელემენტების პოზიცია მასივში. მაშინაც კი, როცა მასივში ელემენტების მდებარეობა  იცვლება, key-ები React-ს საშუალებას აძლევს ამოიცნოს ელემენტი მთელი მისი არსებობის განმავლობაში.',
        text41 : 'შესაძლოა გაგიჩნდეთ ცდუნება, გამოიყენოთ მასივის ელემენტის ინდექსი მის key-დ. სინამდვილეში, სწორედ ინდექსებს იყენებს React, თუკი თქვენ key-ებს არ მიუთითებთ. მაგრამ თანმიმდევრობა, რომლითაც თქვენ არენდერებთ ელემენტებს, შეიძლება შეიცვლოს დროთა განმავლობაში - თუ ახალ ელემენტს ჩასვამთ, წაიშლით ან თუ მასივი ხელახლა გადალაგდება. ინდექსის გამოყენება როგორც key, ხშირად იწვევს დამაბნეველ შეცდომებს.',
        text42 : 'ანალოგიურად, თუკი თქვენ  აგენერირებთ key-ებს ლოკალურად, მაგ key={ Math.random() }, ეს გამოიწვევს იმას, რომ  რენდერებს შორის key-ები არასოდეს დაემთხვევა ერთმანეთს და თქვენი ყველა კომპონენტი და DOM-ის ხე ყოველ ჯერზე ხელახლა შექმნება. ეს არა მხოლოდ შეანელებს აპლიკაციას , არამედ დაკარგავს სიის ელემენტებში მომხმარებლის მიერ შეყვანილ ინფორმაციას. ამის ნაცვლად, მონაცემებზე დაყრდნობით გამოიყენეთ  სტაბილური ID.',
        text43 : 'მიაქციეთ ყურადღება, რომ თქვენი კომპონენტებს  key არ გადაეცემა როგორც props-ი.  იგი გამოიყენება მხოლოდ როგორც მინიშნება თავად React-ის მიერ. თუ თქვენს კომპონენტს სჭირდება იდენტიფიკატორი, თქვენ უნდა გადასცეთ იგი ცალკე props-ად: <Profile key={id} userId={id} />.',
        text44 : 'როგორ გადავიტანოთ მონაცემები კომპონენტებიდან ისეთ მონაცემთა სტრუქტურებში, როგორიცაა მასივები და ობიექტები.',
        text45 : 'როგორ შევქმნათ მსგავსი კომპონენტების ნაკრები JavaScript-ის map() მეთოდით.',
        text46 : 'როგორ შევქმნათ გაფილტრული ელემენტების მასივები JavaScript-ის filter() მეთოდით.',
        text47 : 'რატომ და როგორ დააყენოთ key კოლექციის თითოეულ კომპონენტზე, რათა React-მა შეძლოს თითოეულ მათგანის იდენთიფიკაცია, მაშინაც როცა მათი პოზიცია ან მონაცემები იცვლება.'
     },
     article11 : {
        text1 : '"სუფთა" კომპონენტები',
        text2 : 'JavaScript-ში არსებობს „სუფთა“ ფუნქციები. სუფთა ფუნქციები მხოლოდ გაანგარიშებას ასრულებენ. თუ თქვენი კომპონენტებს სუფთა ფუნქციების პრინციპით შექმნით, თავიდან აიცილებთ მთელ რიგ  დამაბნეველ შეცდომებს და არაპროგნოზირებად ქცევას. ამ უპირატესობების მისაღებად, არსებობს რამდენიმე წესი, რომელიც უნდა დაიცვათ.',
        text3 : '•	რა არის „სუფთა“ კოდი და როგორ გეხმარებათ ის შეცდომების თავიდან აცილებაში',
        text4 : 'შეჯამება',
        text5 : '•	როგორ შევინარჩუნოთ კომპონენტები სისუფთავე და არ დავუშვათ  რენდერის ფაზაში ცვლილებები',
        text6 : '•	როგორ გამოვიყენოთ Strict Mode  კომპონენტებში შეცდომების აღმოსაჩენად',
        text7 : 'სუფთა კოდი: კომპონენტები, როგორც ფორმულები',
        text8 : 'კომპიუტერულ მეცნიერებაში (და განსაკუთრებით ფუნქციონალური პროგრამირების სამყაროში), სუფთა ფუნქცია არის ფუნქცია შემდეგი მახასიათებლებით:',
        text9 : 'ის აკეთებს მხოლოდ თავის საქმეს. არ ცვლის არცერთ ობიექტს ან ცვლადს, რომელიც არსებობდა მის გამოძახებამდე.',
        text10 : 'იგივე მონაცემები, იგივე შედეგი. ერთი და იგივე მონაცემების მიწოდების შემთხვევაში, სუფთა ფუნქცია ყოველთვის უნდა აბრუნებდეს იგივე შედეგს.',
        text11 : 'თქვენ შეიძლება უკვე იცნობდეთ სუფთა ფუნქციების მაგალითს: ფორმულები მათემატიკაში.',
        text12 : 'განვიხილოთ ეს მათემატიკური ფორმულა: y = 2x.',
        text13 : 'თუ x = 2, მაშინ ყოველთვის y = 4.',
        text14 : 'თუ x = 3, მაშინ ყოველთვის y = 6.',
        text15 : 'თუ x = 3, y არასოდეს იქნება 9 , –1 ან 2.5,  მიუხედავად დროისა ან მდგომარეობისა საფონდო ბირჟაზე.',
        text16 : 'თუ y = 2x და x = 3 , y ყოველთვის იქნება 6 .',
        text17 : 'თუ ამ ფორმულას JavaScript ფუნქციად ვაქცევთ, ის ასე გამოიყურება:',
        text18 : 'ზემოთ მოყვანილ მაგალითში double არის სუფთა ფუნქცია. თუ მას მივაწვდით 3-ს, ყოველთვის დაბრუნდება 6.',
        text19 : 'React-ი შექმნილია ამ კონცეფციის გარშემო. React-ში გათვლილია, რომ თქვენ მიერ დაწერილი ყველა კომპონენტი არის სუფთა ფუნქცია. ეს ნიშნავს, რომ თქვენ მიერ დაწერილი React კომპონენტებმა ყოველთვის უნდა დააბრუნონ ერთიდაიგივე JSX, იგივე მონაცემების მიწოდების შემთხვევაში:',
        text20 : 'როდესაც თქვენ Recipe  ფუნქციას მიაწვდით drinkers={2}, ის ყოველთვის დააბრუნებს JSX-ს  - 2 cups of water.',
        text21 : 'თუ მივაწვდით drinkers={4}, ფუნქცია ყოველთვის დააბრუნებს JSX-ს -  4 cups of water',
        text22 : 'ისევე როგორც მათემატიკური ფორმულა.',
        text23 : 'თქვენ შეგიძლიათ წარმოიდგინოთ თქვენი კომპონენტები, როგორც რეცეპტები: თუ მათ მიჰყვებით და მომზადების პროცესში,არ შეიტანთ ახალ ინგრედიენტებს, ყოველ ჯერზე მიიღებთ ერთსა და იმავე კერძს.',
        text24 : 'ეს „კერძი“ არის JSX, რომელსაც კომპონენტი აწვდის React-ს რენდერისთვის.',
        text25 : 'გვერდითი მოვლენები: (არა)პროგნოზირებადი შედეგები',
        text26 : 'React-ის რენდერის პროცესი ყოველთვის სუფთა უნდა იყოს. კომპონენტებმა უნდა დააბრუნონ მხოლოდ თავიანთი JSX და არ შეცვალონ რაიმე ობიექტი ან ცვლადი, რომელიც არსებობდა რენდერამდე - ეს დაარღვევს სისუფთავის პირინციპს!',
        text27 : 'მაგალითში მოცემული კომპონენტი არღვევს ამ წესს:',
        text28 : 'ეს კომპონენტი კითხულობს და შემდეგ გადააწერს ახალ მნიშვნელობას ფუნქციის გარეთ გამოცხადებულ guest  ცვლადს. ამიტომ  ამ კომპონენტის მრავალჯერ გამოძახება დააბრუნებს  სხვადასხვა JSX-ს! და უფრო მეტიც, თუ სხვა კომპონენტებშიც გამოიყენება guest ცვლადი, ისინიც ასევე დააბრუნებენ განსხვავებულ JSX-ს, იმისდა მიხედვით, თუ როდის მოხდა მათი რენდერი! ეს არა პროგნოზირებადი ქცევაა.',
        text29 : 'დავუბრუნდეთ ჩვენს ფორმულას y = 2x. x ამ შემთხვევაში 2-ის ტოლი რომც იყოს, ჩვენ ვერ ვიქნებით დარწმუნებული, რომ y=4 . აპლიკაციაში ტექსტები  არეული იქნება, ჩვენი მომხმარებლები დაბნეული იქნებიან და ა.შ. - ეს გამოიწვევს მრავალ დამაბნეველ შეცდომებს!',
        text30 : 'ამ კომპონენტის გასწორება შესაძლებელია თუკი guest ცვლადს კომპონენტს გადავცემთ, როგორც props-ს:',
        text31 : 'ახლა თქვენი კომპონენტი სუფთაა, რადგან JSX-ის შედეგი მხოლოდ guest props-ზეა დამოკიდებული.',
        text32 : 'ზოგადად, არ არის აუცილებელი, რომ თქვენი კომპონენტები რაიმე კონკრეტული თანმიმდევრობით დარენდერდეს. არ აქვს მნიშვნელობა,  y = 2x-ს გამოვიძახებთ y = 5x გამოძახებამდე თუ გამოძახების შემდეგ: ორივე ფორმულა მოქმედებს ერთმანეთისგან დამოუკიდებლად. ანალოგიურად, თითოეულმა კომპონენტმა უნდა იმოქმედოს დამოუკიდებლად და რენდერის დროს არ ცდილობდეს კოორდინირებას  სხვა კომპონენტებთან.  რენდერის პროცესი გავს სასკოლო გამოცდას: თითოეულმა კომპონენტმა დამოუკიდებლად უნდა დააბრუნოს JSX!',
        text33 : 'უსუფთაო გამოთვლების აღმოჩენა StrictMode-ით',
        text34 : 'მიუხედავად იმისა, რომ შესაძლოა ისინი ჯერ არ გამოგიყენებიათ, React-ში არის სამი სახის მისაწოდებელი მონაცემი, რომელთა გამოყენებაც შეგიძლიათ რენდერის დროს. ესენია props, state და context. ეს მონაცემები უნდა განიხილოთ, როგორც მხოლოდ წაკითხვადი.',
        text35 : 'როდესაც გსურთ შეცვალოთ რაიმე მომხმარებლის მოთხოვნის საპასუხოდ, მონაცემების ცვლადში შენახვის ნაცვლად თქვენ უნდა გამოიყენოთ state. კომპონენტის რენდერის დროს არასოდეს არ უნდა შეცვალოთ არსებული ცვლადები ან ობიექტები.',
        text36 : 'React გთავაზობთ "Strict Mode"-ს, რომელის გამოყენების დროსაც აპლიკაციის შემუშავების პროცესში  ის ორჯერ იძახებს თითოეული კომპონენტის ფუნქციას. კომპონენტის ფუნქციების ორჯერ გამოძახებით, Strict Mode გეხმარებათ იპოვოთ კომპონენტები, რომლებიც არღვევენ ზემოთ აღნიშნულ წესებს.',
        text37 : 'მიაქციეთ ყურადღება, როგორ დარენდერდა პირველ მაგალითში “Guest #2”, “Guest #4” და “Guest #6” ნაცვლად “Guest #1”, “Guest #2” და “Guest #3”-ისა. თავდაპირველი ფუნქცია უსუფთაო იყო, ამიტომ ორჯერ გამოძახების დროს დაირღვა ფუნქციის მოქმედების ლოგიკა.  ფიქსირებული სუფთა ვერსია კი მუშაობს მაშინაც კი, თუ ფუნქცია ყოველ ჯერზე ორჯერ გამოიძახება. სუფთა ფუნქციები მხოლოდ გამოთვლებს ატარებენ, ამიტომ მათი ორჯერ გამოძახება არ ცვლის სხვა მონაცემებს - ისევე როგორც double(2) ფუნქციის ორჯერ გამოძახება არ ცვლის დაბრუნებულ შედეგს და ისევე როგორც y = 2x ფორმულის ორჯერ ამოხსნა  y-ის მნიშვნელობას არ შეცვლის. იგივე მონაცემების შემთხვევაში ყოველთვის ვიღებთ იგივე შედეგს.',
        text38 : 'Strict Mode არ ახდენს გავლენას აპლიკაციის წარმადობაზე, ამიტომ ის არ შეანელებს თქვენს აპლიკაციას. Strict Mode-ის გასააქტიურებლად, შეგიძლიათ ჩასვათ თქვენი root კომპონენტი <React.StrictMode>-ში. ზოგიერთი ფრეიმვორქი ამას სტანდარტულად აკეთებს.',
        text39 : 'ლოკალური მუტაცია: თქვენი კომპონენტის პატარა საიდუმლო',
        text40 : 'ზემოთ მოყვანილ მაგალითში პრობლემა ის იყო, რომ კომპონენტმა შეცვალა უკვე არსებული ცვლადი რენდერის დროს. ამას ხშირად "მუტაციას" უწოდებენ. სუფთა ფუნქციები არ ცვლის  ფუნქციის ფარგლებს გარეთ არსებულ ცვლადებს ან ობიექტებს, რომლებიც შეიქმნა გამოძახებამდე - ეს მათ უსუფთაო ფუნქციებად აქცევს!',
        text41 : 'თუმცა, სრულიად ნორმალურია ცვლადების და ობიექტების შეცვლა, რომლებიც  რენდერის დროს იქმნება. ქვემოთ მოცემულ მაგალითში, იქმნება ცარიელი cups  მასივი და შემდეგ მასში  push( ) მეთოდის გამოყენებით ემატება რამოდენიმე ელემენტი:',
        text42 : 'თუ cups ცვლადს ან [] მასივს შევქმნიდით TeaGathering ფუნქციის მიღმა, ეს გამოიწვევდა დიდი პრობლემებს!  მასივში ელემენტების დამატებით შეიცვლებოდა უკვე არსებულ ობიექტი.',
        text43 : 'თუმცა, ნორმალურია როცა ისინი იქმნება იმავე რენდერის დროს TeaGathering ფუნქციაში. არცერთ გარე კოდს არ ეცოდინება რა შეიცვალა TeaGathering ფუნქციის შიგნით. ეს თქვენი კომპონენტის პატარა საიდუმლოა, რომელსაც "ლოკალური მუტაცია" ჰქვია.',
        text44 : 'სად შეიძლება გამოვლინდეს გვერდითი ეფექტები',
        text45 : 'მიუხედავად იმისა, რომ ფუნქციური პროგრამირება დიდწილად ეყრდნობა კოდის სისუფთავეს, რაღაც მომენტში, სადღაც, რაღაც უნდა შეიცვალოს. პროგრამირების აზრიც ხომ ესაა! ამ ცვლილებებს - ეკრანის განახლებას, ანიმაციის დაწყებას, მონაცემების შეცვლას - გვერდითი ეფექტები (side effects) ეწოდება. ეს არის ისეთი ცვლილებები, რომლებიც  ხდება რენდერის შემდგომ.',
        text46 : 'React-ში გვერდითი ეფექტები, როგორც წესი, მიბმულია მოვლენის დამმუშავებლებს (event handlers). მოვლენის დამმუშავებლები არიან ფუნქციები, რომლებსაც React უშვებს მხოლოდ მაშინ, როდესაც მომხმარებელი ასრულებს რაიმე მოქმედებას, მაგალითად, ღილაკზე დაჭერას. მიუხედავად იმისა, რომ მოვლენის დამმუშავებლები განსაზღვრულია თქვენს კომპონენტში, ისინი არ გაეშვებიან რენდერის დროს! ასე რომ, არ არის აუცილებელი რომ მოვლენის დამმუშავებლები იყვნენ სუფთა ფუნქციები.',
        text47 : 'თუ თქვენ ამოწურეთ ყველა სხვა ვარიანტი და ვერ იპოვნეთ გვერდითი ეფექტის შესაბამისი მოვლენის დამმუშავებელი, ყოველთვის შეგიძლიათ ის მიამაგროთ დაბრუნებულ JSX-ს  useEffect-ის გამოყენებით. ეს მიუთითებს React-ს, რომ მოქმედება შეასრულოს  მოგვიანებით, რენდერის შემდეგ, როდესაც გვერდითი ეფექტები დასაშვები გახდება. თუმცა, ეს მიდგომა უნდა იყოს თქვენი ყველაზე ბოლო საშუალება.',
        text48 : 'თუკი ეს შესაძლებელია, შეეცადეთ გამოხატოთ თქვენი ლოგიკა მხოლოდ რენდერით. გაგიკვირდებათ, რამდენად შორს შეიძლება წაგიყვანოთ ამ მიდგომამ!',
        text49 : 'რატომ ზრუნავს React კომპონენტების სისუფთავეზე?',
        text50 : 'წმინდა ფუნქციების წერას გარკვეული ჩვევა და დისციპლინა სჭირდება. მაგრამ ის ასევე ხსნის საოცარ შესაძლებლობებს:',
        text51 : 'თქვენი კომპონენტები შეიძლება მუშაობდეს სხვა გარემოშიც - მაგალითად, სერვერზე! ვინაიდან ისინი აბრუნებენ ერთსა და იმავე შედეგს ერთიდაიგივე მონაცემის მიწოდების დროს, ერთ კომპონენტს შეუძლია მომხმარებლის მრავალნაირ მოთხოვნას მოემსახუროს.',
        text52 : 'თქვენ შეგიძლიათ გააუმჯობესოთ აპლიკაციის წარმადობა იმ კომპონენტების რენდერის გამოტოვებით, რომელთა მისაწოდებელი მონაცემებიც არ შეცვლილა. რადგან სუფთა ფუნქციები ყოველთვის ერთსა და იმავე შედეგებს აბრუნებს, ამიტომ შესაძლებელია მათი უსაფრთხო ქეშირება.',
        text53 : 'თუ რენდერის დროს მოხდება მონაცემის ცვლილება, React-ს შეუძლია გადატვირთოს რენდერი ისე, რომ დრო არ დაკარგოს ძველი რენდერის დასასრულებლად. ფუნქციების სისუფთავე უზრუნველყოფს რენდერის ნებისმიერ დროს განახლებას.',
        text54 : 'ყოველი ახალი React ფუნქცია, რომელსაც ჩვენ ვქმნით, იყენებს სისუფთავის უპირატესობას. მონაცემთა მიღებით დაწყებული ანიმაციებით დასრულებული, კომპონენტების სისუფთავის შენარჩუნება სრულად უხსნის გზას  React-ის  პარადიგმის ძალას.',
        text55 : 'კომპონენტი უნდა იყოს სუფთა, რაც ნიშნავს:',
        text56 : 'ის მხოლოდ თავის საქმეს აკეთებსს. მან არ უნდა შეცვალოს რაიმე ობიექტი ან ცვლადი, რომელიც არსებობდა რენდერამდე.',
        text57 : 'იგივე მონაცემები, იგივე შედეგი. ერთი და იგივე მონაცემების მიწოდების გათვალისწინებით, კომპონენტმა ყოველთვის უნდა დააბრუნოს ერთი და იგივე JSX.',
        text58 : 'რენდერი შეიძლება მოხდეს ნებისმიერ დროს, ამიტომ კომპონენტები არ უნდა იყვნენ დამოკიდებული ერთმანეთის რენდერის თანმიმდევრობაზე.',
        text59 : 'თქვენ არ უნდა მოახდინოთ ისეთი მონაცემების ცვლილება, რომელსაც თქვენი კომპონენტები იყენებენ რენდერისთვის. ეს მოიცავს props-ს,  state-ს და context-ს. ეკრანის განახლებისთვის, უკვე არსებული ობიექტების ცვლილების ნაცვლად გამოიყენეთ state.',
        text60 : 'შეეცადეთ გამოხატოთ თქვენი კომპონენტის ლოგიკა ფუნქციის მიერ დაბრუნებულ JSX-ში. როდესაც თქვენ დაჭირდებათ რაიმეს ცვლილება, ჩვეულებრივ ამის გაკეთება შესაძლებელია მოვლენის დამმუშავებლებით, ხოლო  როგორც უკანასკნელი საშუალება, შეგიძლიათ გამოიყენოთ useEffect.',
        text61 : 'სუფთა ფუნქციების დაწერას გარკვეული პრაქტიკა სჭირდება, მაგრამ ის ხსნის React-ის პარადიგმის ძალას.'        
     }
}
export default data