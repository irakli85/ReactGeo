const data = {
    ...
    article9 : {
     ...
     article11 : {
        ...
        text2 : 'JavaScript-ში არსებობს „სუფთა“ ფუნქციები. სუფთა ფუნქციები მხოლოდ გაანგარიშებას ასრულებენ და მეტი არაფერი. თუ თქვენი კომპონენტებს სუფთა ფუნქციების პრინციპით შექმნით, თავიდან აიცილებთ მთელ რიგ  დამაბნეველ შეცდომებს და არაპროგნოზირებად ქცევას. ამ უპირატესობების მისაღებად, არსებობს რამდენიმე წესი, რომელიც უნდა დაიცვათ.',
        ...
        text18 : 'ზემოთ მოყვანილ მაგალითში double არის სუფთა ფუნქცია. თუ მას მივაწვდით 3-ს, ყუველთვის დაბრუნდება 6.',
        ...
        text25 : 'გვერდითი მოვლენები: (არა)პროგნოზირებული შედეგები',
        ...
        text29 : 'დავუბრუნდეთ ჩვენს ფორმულას y = 2 x , ამ შემთხვევაში  x 2-ის ტოლი რომც იყოს , ჩვენ ვერ ვიქნებით დარწმუნებული, რომ y = 4 . აპლიკაციაში ტექსტები  არეული იქნება, ჩვენი მომხმარებლები დაბნეული იქნებიან და ა.შ. - ეს გამოიწვევდა მრავალ დამაბნეველ შეცდომებს!',
        text30 : 'ამ კომპონენტის გასწორება შესაძლებელია თუკი guest ცვლადს გადავცემთ, როგორც props-ს:',
        text31 : 'ახლა თქვენი კომპონენტი სუფთაა, რადგან JSX-ის შედეგის დაბრუნდება მხოლოდ  guest props-ზეა დამოკიდებული.',
        text32 : 'ზოგადად, არ არის აუცილებელი, რომ თქვენი კომპონენტები რაიმე კონკრეტული თანმიმდევრობით დარენდერდეს. არ აქვს მნიშვნელობა,  y = 2 x-ს გამოვიძახებთ y = 5 x გამოძახებამდე თუ გამოძახების შემდეგ : ორივე ფორმულა მოქმედებს ერთმანეთისგან დამოუკიდებლად. ანალოგიურად, თითოეულმა კომპონენტმა უნდა იმოქმედოს დამოუკიდებლად და რენდერის დროს არ ცდილობდეს კოორდინირებას  სხვა კომპონენტებთან.  რენდერის პროცესი გავს სასკოლო გამოცდას: თითოეულმა კომპონენტმა დამოუკიდებლად უნდა დააბრუნოს JSX!',
        ...
        text35 : 'როდესაც გსურთ შეცვალოთ რაიმე მომხმარებლის მოთხოვნის საპასუხოდ, მონაცემების ცვლადში შენახვის ნაცვლად თქვენ უნდა გამოიყენოთ state. კომპონენტის რენდერის არასოდეს არ უნდა შეცვალოთ არსებული ცვლადები ან ობიექტები.',
        ...
        text37 : 'მიაქციეთ ყურადღება, როგორ დარენდერდა პირველ მაგალითში “Guest #2”, “Guest #4”, და “Guest #6” ნაცვლად “Guest #1”, “Guest #2”და “Guest #3”-ისა. თავდაპირველი ფუნქცია უსუფთაო იყო, ამიტომ ორჯერ გამოძახების დროს დაირღვა ფუნქციის მოქმედების ლოგიკა.  ფიქსირებული სუფთა ვერსია კი მუშაობს მაშინაც კი, თუ ფუნქცია ყოველ ჯერზე ორჯერ გამოიძახება. სუფთა ფუნქციები მხოლოდ გამოთვლებს ატარებენ, ამიტომ მათი ორჯერ გამოძახება არ ცვლის სხვა მონაცემებს- ისევე როგორც double(2) ფუნქციის ორჯერ გამოძახება არ ცვლის დაბრუნებულ შედეგს და ისევე როგორც y = 2x ფორმულის ორჯერ ამოხსნა  y-ის მნიშვნელობას . იგივე მონაცემების შემთხვევაში ყოველთვის ვიღებთ იგივე შედეგს.',
        ...
        text43 : 'თუმცა, ნორმალურია როცა თქვენ შექმენით ისინი იმავე რენდერის დროს TeaGathering ფუნქციის შიგნით. არცერთ გარე კოდს არ ეცოდინება რა შეიცვალა TeaGathering ფუნქციის შეგნით. ეს თქვენი კომპონენტის პატარა საიდუმლოა, რომელსაც "ლოკალური მუტაცია" ჰქვია.',
        ...
        text49 : 'რატომ ზრუნავს React სისუფთავეზე?',
        text50 : 'წმინდა ფუნქციების წერას გარკვეული ჩვევა და დისციპლინა სჭირდება. მაგრამ ის ასევე ხსნის საოცარ შესაძლებლობებს:',
        text51 : '•	თქვენი კომპონენტები შეიძლება მუშაობდეს სხვა გარემოშიც - მაგალითად, სერვერზე! ვინაიდან ისინი აბრუნებენ ერთსა და იმავე შედეგს ერთი და იგივე მონაცემის მიწოდების დროს, ერთ კომპონენტს შეუძლია მომხმარებლის მრავალნაირ მოთხოვნას მოემსახუროს.',
        text52 : '•	თქვენ შეგიძლიათ გააუმჯობესოთ აპლიკაციის წარმადობა იმ კომპონენტების რენდერის გამოტოვებით , რომელთა მისაწოდებელი მონაცემების არ შეცვლილა. რადგან სუფთა ფუნქციები ყოველთვის ერთსა და იმავე შედეგებს აბრუნებს, ამიტომ შესაძლებელია მათი უსაფრთხო ქეშირება.',
        text53 : '•	თუ რენდერის დროს მოხდება მონაცემის ცვლილება, React-ს შეუძლია გადატვირთოს რენდერი ისე, რომ დრო არ დაკარგოს ძველი რენდერის დასასრულებლად. ფუნქციებია სისუფთავე უზრუნველყოფს რენდერის ნებისმიერ დროს განახლებას.',
        ...
        text59 : '•	თქვენ არ უნდა მოახდინოთ ისეთი მონაცემების ცვლილება, რომელსაც თქვენი კომპონენტები იყენებენ რენდერისთვის. ეს მოიცავს props-ს,  state-ს და context-ს. ეკრანის განახლებისთვის, უკვე არსებული ობიექტების ცვლილების ნაცვლად  „დააყენეთ“ state.',
